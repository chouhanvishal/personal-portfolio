        ...
        <div className="bg-white border-b border-gray-200 shadow-sm">
          <div className="flex items-center justify-between p-4 lg:p-6">
            <div className="flex items-center gap-3">
              ...
              <Settings className="w-6 h-6 lg:w-8 lg:h-8 text-gray-700" />
              <div>
                <h2 className="text-xl lg:text-2xl font-bold text-gray-900">Admin Panel</h2>
                <p className="text-gray-600 text-sm hidden sm:block">Manage your portfolio content</p>
              </div>
            </div>
                  ...
                  {tabItems.map((tab) => {
                    ...
                    return (
                      <TabsTrigger
                        key={tab.value}
                        value={tab.value}
                        className="flex items-center gap-3 justify-start h-12 px-3 rounded-lg data-[state=active]:bg-blue-50 data-[state=active]:text-blue-600 data-[state=active]:border data-[state=active]:border-blue-200 transition-all duration-200"
                        onClick={() => setMobileMenuOpen(false)}
                      >
